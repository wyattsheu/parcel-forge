# S2 open-box run 20260916T101258Z_s2_open_box_tall

- Case: **open_box_tall**  (fault: `none`)
- Expected outcome: **inside**
- Observed outcome: **inside**
- UTC: 2026-09-16T10:13:13Z
- Command: `/mnt/HDD4/wyattsheu/IsaacLab/.venv/bin/python3 /mnt/HDD4/wyattsheu/ITRI/parcel-forge/src/parcel_forge/box_s2.py --out /mnt/HDD4/wyattsheu/ITRI/parcel-forge/runs/20260916T101258Z_s2_open_box_tall --case /mnt/HDD4/wyattsheu/ITRI/parcel-forge/runs/20260916T101258Z_s2_open_box_tall/request.json --profile /mnt/HDD4/wyattsheu/ITRI/parcel-forge/runs/20260916T101258Z_s2_open_box_tall/profile.json`
...
| offline PNG render | ok | renders/open_box_tall_interior_top.png, renders/open_box_tall_side_low.png |
| WebRTC human view | not_tested | no agent evidence possible |

## Measured positions

- Final world position: [-0.00030042900471016765, -0.0003635906323324889, 0.22499999403953552]
- Final box-local position: [-0.00030042900471016765, -0.0003635906323324889, 0.02499999403953551]
- Lowest box-local z reached: 0.020446974039077748
- Final speed: 6.148369435139906e-05 m/s
...
| id | status | detail |
| --- | --- | --- |
| S2.plate_dimensions_match_spec | pass | largest world-size error 0.00000001 m on wall_x_pos (tolerance 0.0001 m), read back through the composed transform |
...
| S2.render_png_not_blank | pass | interior_top=378516 B mean_r=213.3825; side_low=133878 B mean_r=223.7447 |
...
- `summary.md`
- `trajectory.csv`
- `renders/open_box_tall_interior_top.png`
- `renders/open_box_tall_side_low.png`
