# S2 open-box run 20260916T101157Z_s2_open_box_no_bottom

- Case: **open_box_no_bottom**  (fault: `missing_bottom`)
- Expected outcome: **fell_through**
- Observed outcome: **fell_through**
- UTC: 2026-09-16T10:12:12Z
- Command: `/mnt/HDD4/wyattsheu/IsaacLab/.venv/bin/python3 /mnt/HDD4/wyattsheu/ITRI/parcel-forge/src/parcel_forge/box_s2.py --out /mnt/HDD4/wyattsheu/ITRI/parcel-forge/runs/20260916T101157Z_s2_open_box_no_bottom --case /mnt/HDD4/wyattsheu/ITRI/parcel-forge/runs/20260916T101157Z_s2_open_box_no_bottom/request.json --profile /mnt/HDD4/wyattsheu/ITRI/parcel-forge/runs/20260916T101157Z_s2_open_box_no_bottom/profile.json`
...
| offline PNG render | ok | renders/open_box_no_bottom_interior_top.png, renders/open_box_no_bottom_side_low.png |
...
| S2.render_png_not_blank | pass | interior_top=322424 B mean_r=220.6191; side_low=157481 B mean_r=223.5983 |
...
- `summary.md`
- `trajectory.csv`
- `renders/open_box_no_bottom_interior_top.png`
- `renders/open_box_no_bottom_side_low.png`
