# S3 build+validate 20260916T133443Z_s3_verify_open_box_sealed

- Case: **open_box_sealed**
- UTC: 2026-09-16T13:34:44Z
- parcel-forge exit code: 0

## Built asset

- File: `asset.usda`  (defaultPrim `/OpenBox`)
- Plates: 6, body_mode `static`
- Interior: 0.2900 x 0.1900 x 0.1450 m, floor at local z = 0.0050 m
- Plate volume: 0.0012860000 m^3
...
| G1.collider_count | pass | 6 colliders, expected 6 |
